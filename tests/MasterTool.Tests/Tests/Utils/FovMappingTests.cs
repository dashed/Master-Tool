...
namespace MasterTool.Tests.Tests.Utils
{
    ...
    public class FovMappingTests
    {
        ...
        private static float MapWeaponClassToFov(string weaponClass)
        {
            ...
            {
                case "pistol": return FovPistol;
                case "smg": return FovSMG;
                case "assaultrifle":
                case "assaultcarbine": return FovAssaultRifle;
                case "shotgun": return FovShotgun;
                case "marksmanrifle":
                case "sniperrifle": return FovSniper;
                case "machinegun": return FovAssaultRifle;
                default: return FovDefault;
            }
        }
